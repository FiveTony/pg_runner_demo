...
export default class PreloadScene extends Phaser.Scene {
  ...
  preloadAssets() {
    ...
    // this.load.image("start", "src/assets/sprites/2version/start.png");
    ...
    this.load.atlas(
      "ui_spritesheet", "src/assets/sprites/2version/ui/ui_spritesheet.png", 
      "src/assets/sprites/2version/ui/ui_spritesheet.json");

    this.load.atlas(
      "prompts_spritesheet", "src/assets/sprites/2version/prompts_spritesheet.png", 
      "src/assets/sprites/2version/prompts_spritesheet.json");
  ...
  preloadRooms() {
    ...
    //   "src/assets/sprites/2version/rooms/rooms_spritesheet.json");
  }
  preloadNegativePositive() {
    this.load.atlas(
      "negative_spritesheet", "src/assets/sprites/2version/negative/negative_spritesheet.png", 
      "src/assets/sprites/2version/negative/negative_spritesheet.json");

    this.load.atlas(
      "positive_spritesheet", "src/assets/sprites/2version/positive/positive_spritesheet.png", 
      "src/assets/sprites/2version/positive/positive_spritesheet.json");
  }
  createElements() {
    this.add.graphics()
