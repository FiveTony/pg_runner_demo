...
export default class Negative extends Phaser.Physics.Arcade.Group {
    ...
    createFirstElements() {
        let data_1 = DATA[0]
        let elem_1 = new NegativeObject(this.scene, 100, 100, 'negative_spritesheet', 'room1_1')
        elem_1.move()
        this.add(elem_1)

        let data_2 = DATA[1]
        let elem_2 = new NegativeObject(this.scene, 200, -700, 'negative_spritesheet', 'room1_2')
        elem_2.move()
        this.add(elem_2)

        let data_3 = DATA[2]
        let elem_3 = new NegativeObject(this.scene, 300, -1250, 'negative_spritesheet', 'room1_3')
        elem_3.move()
        this.add(elem_3)

        let data_4 = DATA[3]
        let elem_4 = new NegativeObject(this.scene, 100, -2470, 'negative_spritesheet', 'room2_1')
        elem_4.move()
        this.add(elem_4)

        let data_5 = DATA[4]
        let elem_5 = new NegativeObject(this.scene, 200, -3300, 'negative_spritesheet', 'room2_2')
        elem_5.move()
        this.add(elem_5)

        let data_6 = DATA[5]
        let elem_6 = new NegativeObject(this.scene, 300, -4000, 'negative_spritesheet', 'room2_3')
        elem_6.move()
        this.add(elem_6)
