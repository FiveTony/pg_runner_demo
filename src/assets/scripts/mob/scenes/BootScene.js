export default class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("circle", "src/assets/sprites/mob/PreloadScene/circle.png");
    this.load.image("pg_label", "src/assets/sprites/mob/PreloadScene/pg_label.png");
    this.load.image("pattern", "src/assets/sprites/mob/PreloadScene/pattern.png");
